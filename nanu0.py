...
# Author: SHIFAT
# GitHub: https://github.com/5h1f47
# Version: 4.1.0
#########################################
...
def update():
    ...
    try:
        parsedData = requests.get("https://raw.githubusercontent.com/Toxic-Noob/👉🕳️👈😈👉🕳️👈/main/more/.version").json()
    except:
    ...
    if (toolVersion != mainVersion):
        ...
        os.system("cd .. && rm -rf 👉🕳️👈😈👉🕳️👈 && git clone https://github.com/Toxic-Noob/👉🕳️👈😈👉🕳️👈 > /dev/null 2>&1")
        
        print("\033[37mDone")
        psb("\n    \033[92m[\033[37m*\033[92m] \033[37mStarting Tool...")
        time.sleep(0.8)
        
        os.system("cd .. && cd 👉🕳️👈😈👉🕳️👈 && python Tbomb.py")
...
def logo():
    ...
    print("\033[94m│     \033[92m SHIFAT ZAMAN    \033[94m   │".center(columns+15))
    print("\033[94m│                              \033[94m          │".center(columns+9))
    print("\033[94m│ \033[95mAuthor : SHIFAT                \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/5h1f47 \033[94m│".center(columns+9))
    print("│ \033[95mCoder  : SHIFAT              \033[37mV4.1 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
...
def check(sent):
    ...
    if (sent == amount):
        ...
        psb("\033[92m    [\033[37m*\033[92m] From   : \033[37m👉🕳️👈😈👉🕳️👈\n")
        time.sleep(0.6)
...
def main():
    ...
    amount = input("    \033[92m[\033[37m*\033[92m] \033[37mEnter Amount (\033[92mDefault: 02\033[37m):> \033[37m")
    try:
        amount = int(amount)
    except:
        amount = 10
    ...
    delay = input("    \033[92m[\033[37m*\033[92m] \033[37mEnter Time(\033[92mSec\033[37m) Delay (\033[92mDefault: 3s\033[37m):> \033[37m")
    try:
        delay = int(delay)
    except:
        delay = 2
